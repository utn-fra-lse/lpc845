...
- pin_list:
  ...
  - {pin_num: '16', peripheral: GPIO, signal: 'PIO1, 2', pin_signal: PIO1_2/CAPT_X3, mode: pullUp, invert: disabled, hysteresis: enabled, opendrain: disabled, smode: bypass,
    clkdiv: div0}
  - {pin_num: '37', peripheral: ACMP, signal: ACMP_IN3, pin_signal: PIO0_14/ACMP_I3/ADC_2, mode: inactive, invert: disabled, hysteresis: enabled, opendrain: disabled,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t IOCON_INDEX_PIO0_14_config = (/* No addition pin function */
                                                 ...
                                                 /* IOCONCLKDIV0 */
                                                 IOCON_PIO_CLKDIV0);
    /* PIO0 PIN14 (coords: 37) is configured as ACMP, ACMP_IN3. */
